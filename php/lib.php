...
function getNumCustByMonth($month, $year) {
        //
    $start = $year."-".$month."-01";
    if ($month == "12") { 
            $year++; 
...
function getManagedServiceCases($n=5) {
...
//
//
function getLastRegisteredHours() {
// MSSQL and print it.
$query = mssql_query('
...
do {
	...
	print "<tr><td>EW-kontakt: ".$row[2]."</td</tr>";
...
function getFoo($param, $optional=false){
if ($optional) {
    returm $param
}
  return false;
